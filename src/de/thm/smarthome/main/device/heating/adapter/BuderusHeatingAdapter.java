...
public class BuderusHeatingAdapter  extends AObservable implements IHeating, IObserver {
    ...
    public BuderusHeatingAdapter(String productSerialNumber, String heizungsIP, String heizungsname){

        driver = new BuderusHeatingDriver(productSerialNumber, heizungsIP, heizungsname);
    }
